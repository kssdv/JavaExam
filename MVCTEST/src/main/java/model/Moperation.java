...
public class Moperation {
	...
	private Store makeStore() {
		...
		// 商品追加
		store.add(new Product("A110", "商品01", 2000));
		store.add(new Product("A120", "商品02", 3600));
		store.add(new Product("A130", "商品03", 3900));
		store.add(new Product("A140", "商品04", 2900));
		store.add(new Product("A150", "商品05", 9800));
		store.add(new Product("A160", "商品06", 1900));
		store.add(new Product("A170", "商品07", 3500));
		store.add(new Product("A180", "商品08", 11000));
		store.add(new Product("A190", "商品09", 4200));
		store.add(new Product("A200", "商品10", 7800));
