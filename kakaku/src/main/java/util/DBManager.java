...
//	private static final String password = "1234"; // PostgreSQL pass
//	private static final String dbserver = "jdbc:postgresql://localhost:5432/"; // Postgres Server
//	private static final String dbname = "postgres"; // DataBase name
//	private static final String driveName = "org.postgresql.Driver"; // PostgreSQL Driver name
	// DBCP(커넥션 풀) 사용 방식 (PostgreSQL)
